...
$acal_id = $data['acal_id'];

require_once("connection.php");


$get_file = "select acal_file from tbl_acal where acal_id={$acal_id}";
$res_file = mysqli_query($con, $get_file);
$row_file = mysqli_fetch_assoc($res_file);

if(unlink('files/acal/'.$row_file['acal_file'])){

    $sql = "delete from tbl_acal where acal_id = {$acal_id}";
